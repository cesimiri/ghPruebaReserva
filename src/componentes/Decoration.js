                    ...
                    <div className="p-4 mx-auto max-w-xl bg-white rounded-lg border shadow-md sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                        <div className="flex items-center space-x-4">
                            ...
                            <div className="flex-1 min-w-0">
                                <a href='#Cuarto' className='text-left text-blue-400 hover:text-blue-700'>Anterior</a>
                            </div>
                            <div className="flex-1 min-w-0">
                            ...
                            <div className="flex-1 min-w-0">
                                <a href='#Consumables' className='text-right text-blue-400 hover:text-blue-700'>Siguiente</a>
                            </div>
                        </div>
